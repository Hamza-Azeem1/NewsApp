...
class _ToolFormState extends State<ToolForm> {
  ...
  late TextEditingController _toolLinkCtrl;
  ...
  void initState() {
    super.initState();
    final t = widget.initial ?? Tool.empty();

    _nameCtrl = TextEditingController(text: t.name);
    _shortDescCtrl = TextEditingController(text: t.shortDesc);
    _descCtrl = TextEditingController(text: t.description);
    _toolLinkCtrl = TextEditingController(text: t.toolLink);
    ...
    final initialCat = t.category.trim();
  ...
  Future<void> _submit() async {
    ...
    try {
      final base = widget.initial ?? Tool.empty();

      // Join categories into comma-separated string (sorted)
      ...
      if (base.id.isEmpty) {
        await _repo.upsertTool(tool.copyWith(id: '')); // repo should handle id
      } else {
  ...
  /// Category picker dialog (Option A:
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: FilledButton.icon(
                        ...
                        label: Text(isEdit ? 'Save changes' : 'Add Tool'),
